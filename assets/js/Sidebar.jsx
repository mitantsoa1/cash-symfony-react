...
function Sidebar({ isShow, isConnected, isAdmin = false }) {
  ...
  return (
    <div className="w-1/6 h-screen text-white bg-slate-900 ">
      <div className="flex items-center justify-center text-3xl font-extrabold text-center text-yellow-200 bg-blue-600 font-spantaran h-14">
        CASH POINT
      </div>
      <ul className="">
        ...
        <SidebarItem to="/compte" isConnected={isConnected}>
          <svg
            className="w-5 h-5 mr-3 svg-inline--fa fa-balance-scale fa-w-20"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
        ...
        <SidebarItem to="/adresse" isConnected={isConnected}>
          <svg
            className="w-5 h-5 mr-3 svg-inline--fa fa-address-card fa-w-18"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
        ...
        <SidebarItem to="/transaction" isConnected={isConnected}>
          <svg
            className="w-5 h-5 mr-3 svg-inline--fa fa-chart-line fa-w-16"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
        ...
        <SidebarItem to="/gain" isConnected={isConnected}>
          <svg
        ...
        {/* <SidebarItem to="/etat" isConnected={isConnected}>
          <svg
            className="w-5 h-5 mr-3 svg-inline--fa fa-chart-bar fa-w-16"
            aria-hidden="true"
            focusable="false"
        ...
        {isConnected ? (
          ...
          <>
            <SidebarItem to="/login" isConnected={true}>
              <svg
                className="w-5 h-5 mr-3 svg-inline--fa fa-chart-bar fa-w-16"
                aria-hidden="true"
                focusable="false"
